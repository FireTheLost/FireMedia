...
function generateRandomKey()
{
  ...
  $sql="SELECT * FROM comments WHERE commentsRandomKey='".$randomKey."';";
...
{
  include 'dbh.inc.php';
  $sql="INSERT INTO comments (commentsRandomKey, commentsAuthor, commentsMessage, commentsFile, commentsDate) VALUES (?, ?, ?, ?, ?);";
  $stmt=mysqli_stmt_init($conn);
  if (!mysqli_stmt_prepare($stmt, $sql))
  {
    header("location: ../codes/blog.php?blog=$file");
    exit();
  }
